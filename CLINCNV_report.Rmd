...
|Variant                 | Type            | Classification according to ACMG^1^       |     |
|:----------------------:|:---------------:|:-----------------------------------------:|:--------:|
...
### **Intersecting dosage-sensitive & disease genes and syndromes**
...
### **Methods**
#### General Aspects
<p>This automatically generated report provides an overview on the evaluation of a selected CNV in the context of this website. We combine multiple expert-curated resources on genetic and clinical data.</p> 

#### Limitations 
<p>The analysis has been performed in a research setting. The contents of this report have been carefully checked and created to the best of our knowledge. But for the information presented here is no claim to completeness, timeliness, quality and accuracy. No responsibility can be accepted for any damage caused by reliance on or use of the contents of this report. We object to any commercial use and disclosure of data.</p>
